...
export default function Popover({
  ...
  //* tạo 1 id để đưa vào FloatingPortal
  const id = useId()

  //* Function show/hide Popover khi user onMouseEnter/onMouseLeave
  const showPopover = () => {
    setOpen(true)
  }
  const hidePopover = () => {
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              ...
              />
              {/* Nội dung được render: English + tiếng việt */}
              {renderPopover}
            </motion.div>
          )}
        </AnimatePresence>
